...
#define MPIOCLASS_COMMON_INSTANCE    0
...
typedef struct {
  ...
  uint8_t     PortDevMap[MAX_INSTANCE_ID * MAX_PORT_DEVICE_MAP_SIZE];
  ...
  bool        ActiveSltMode; ///< Inform MPIO if SLT Mode is enabled
...
extern const MPIOCLASS_COMMON_INPUT_BLK mMpioClassDflts;
