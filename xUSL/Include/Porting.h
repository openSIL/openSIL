...
; @file  Porting.h
; @brief
;  SIL declarations. This file is used by all of the xSIM, xPRF  and
...
;***************************************************************************
;*  These account for differences between the tool chains (GCC vs MSVC).
;*
...
;*   methodology to make the declaration.
;*
