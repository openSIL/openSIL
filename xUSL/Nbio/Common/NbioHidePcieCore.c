 ...
 * @param   PciePort            PciePorter on this PcieCore
 * @param   Buffer              Save the hidden PcieCore's Info
 * @param   PcieCore            PcieCore to be hidden
 */
 ...
 *                              can be passed to openSIL. The host firmware is responsible
 *                              for initializing the SIL_CONTEXT structure.
 * @param   PcieCore            PcieCore configuration info
 * @param   Buffer              Buffer pointer points to the hidden PcieCore's Info
 * @param   GnbHandle           Points to a silicon configuration structure data
 */
static void
FindPcieCoreDesc (
  SIL_CONTEXT           *SilContext,
 ...
 *                              for initializing the SIL_CONTEXT structure.
 *  @param  GnbHandle           Points to a silicon configuration structure data
 *  @param  PcieCoreNum         WrapId to be hidden
  ...
  )
{
  ...
  PcieConfigRunProcForAllWrappersInNbio(SilContext,
  ...
  PcieConfigRunProcForAllEnginesInWrapper(SilContext,
