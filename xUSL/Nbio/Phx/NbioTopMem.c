 ...
 * @retval SilInvalidParameter - GnbHandle is NULL
 *
 */
SIL_STATUS
NbioSetTopOfMemory (
  ...
  )
{
  ...
  while (GnbHandle != NULL) {
    ...
    xUSLSmnWrite(GnbHandle->Address.Address.Segment,
      GnbHandle->Address.Address.Bus,
      NBIO_SPACE(GnbHandle, IOHCx13b00090),
      TOP_OF_DRAM.Value
      );
    xUSLSmnWrite(GnbHandle->Address.Address.Segment,
      GnbHandle->Address.Address.Bus,
      NBIO_SPACE(GnbHandle, IOHCx13b10064),
      TOM2_LOWER_REG.Value
      );
    xUSLSmnWrite(GnbHandle->Address.Address.Segment,
      GnbHandle->Address.Address.Bus,
      NBIO_SPACE(GnbHandle, IOHCx13b10068),
      TOM2_UPPER_REG.Value
      );
    xUSLSmnWrite(GnbHandle->Address.Address.Segment,
      GnbHandle->Address.Address.Bus,
      NBIO_SPACE(GnbHandle, IOHCx13b10138),
      TOM3_REG.Value
      );
