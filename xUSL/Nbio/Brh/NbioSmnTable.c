 ...
 * @param[in] Table             Pointer to the Table. Table refers here an array of register addresses and its values
 *                              that are supposed to be programmed. Example: GnbIommuEnvInitTable for initializing IOMMU.
 ...
 * @param[in] Property          Controls the register write operation. Bit position in the property value
