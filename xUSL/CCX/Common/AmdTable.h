...
typedef enum {
  ...
  MsrCoreRev,              ///< MSR which depend on family / Core revision.
                           ///< (This type checks CPU core revision, not SoC revision)
...
#define AMD_PF_BRANCH_SAMPLING  BIT_32(7)
 ...
 *
 */
#define SMUSVI0_PLANE1_LOAD_INDEX 0xD8230000
#define SIL_RESERVED_0003 0xD8230004
...
/**
 * @brief   Table Entry Data for CPU revision (SoC revision) specific MSRs.
 *
 * @details Apply data to register after mask, for MSRs.
 */
typedef struct {
...
/**
 * @brief   Table Entry Data for Core revision (Silicon revision) specific MSRs.
 *
 * @details Apply data to register after mask, for MSRs.
 */
typedef struct {
 ...
 * @retval void
 */
typedef void F_DO_TABLE_ENTRY (ENTRY_CRITERIA    *Criteria,
