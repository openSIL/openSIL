 ...
 *  platform uses a paged style ProcessorRevisionID ROM, then the Host
 *  must assure that the proper page is set to be visible when this data
 *  is referenced.
 */
typedef struct {
...
typedef struct {
  ...
  uint8_t  AmdDownCoreMode;     ///< (ZEN5) Down core mode specifies the desired
  ...
  bool     EnableFSRM;           ///< This selects the state of the Fast Short Repeat Move String (FSRM) instruction
                                 ///< capability in the processor.
  bool     EnableERMS;           ///< This selects the state of the Enhanced Repeat Move String (ERMS) instruction
                                 ///< capability in the processor.
  ...
  uint8_t  AmdCpuPauseDelay;               ///< (ZEN5) Control number of cycles a thread will be idle
                                           ///< after PAUSE instruction.
  bool     AmdStatisticalCorrectPredictor; ///< (ZEN5) Enable Statistical Correct Predictor (SCP)
  uint8_t  CpuPauseCntSel_1_0;             ///< (ZEN5) Value to control number of cycles dispatch stalled for a thread
                                           ///< after dispatching PAUSE instruction.
                                           ///< Permitted Values: (Type: List)(Default: CPU_PAUSECNTSEL_1_0_AUTO)
                                           ///< CPU_PAUSECNTSEL_1_0_16CYCLES  - 16 Cycles.
                                           ///< CPU_PAUSECNTSEL_1_0_32CYCLES  - 32 Cycles.
                                           ///< CPU_PAUSECNTSEL_1_0_64CYCLES  - 64 Cycles.
                                           ///< CPU_PAUSECNTSEL_1_0_128CYCLES - 128 Cycles.
...
#define SIL_PSTATE0_CUSTOM  1
#define SIL_PSTATE0_AUTO    2
