...
;------------------------------------------------------------------------------
xUslWriteCr0:
    mov     rax, rcx ; Move parameter 1 from RCX to RAX (Microsoft x64 calling convention)
    mov     cr0, rax ; Write the value in RAX to CR0
    ret
...
xUslWriteCr3:
    mov     rax, rcx ; Move parameter 1 from RCX to RAX (Microsoft x64 calling convention)
    mov     cr3, rax ; Write the value in RAX to CR3
    ret
...
;------------------------------------------------------------------------------
xUslReadCr0:
    mov     rax, cr0 ; Read the value of CR0 into RAX, which will be returned to the C function
    ret
...
;------------------------------------------------------------------------------
xUslReadCr3:
    mov     rax, cr3 ; Read the value of CR3 into RAX, which will be returned to the C function
    ret
