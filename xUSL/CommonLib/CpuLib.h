...
/// CPUID Fn80000001 EBX BrandId Identifier
typedef struct {
  uint32_t :28;                        ///< Reserved
  uint32_t PkgType:4;                  ///< Package Type
} BRANDID_CPUID_REGISTER;
...
/**
 * Reg(Core::X86::Cpuid::ExtTopEnumEax0)
 * Classification(Pub)
 */
typedef union {
  struct {
...
#define CPUIDx0000000B 0x0000000Bul

#define CPUIDx80000026         0x80000026ul
