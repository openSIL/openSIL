...
#define CCX_MAX_CORES_PER_COMPLEX         16                             ///< Max cores per complex
#define CCX_MAX_THREADS_PER_CORE          2                              ///< Max threads per core
#define CCX_NOT_PRESENT                   (0xFF)                         ///< Not present
#define MAX_CCDS_PER_IOD                  16                             ///< Max CCDs per Die
...
#define MAX_CCDS_PER_DIE                  16                             // 16 Zen 5
#define MAX_COMPLEXES_PER_CCD             1                              ///< MAX_CCX_PER_CCD
#define MAX_THREADS_PER_CORE              2                              ///< Fixed for Zen
#define MAX_CCX_PER_CCD_BRH               1
#define MAX_CORES_PER_CCX_BRH             8
#define MAX_CCD_PER_SOCKET                MAX_CCDS_PER_DIE *CCX_MAX_DIES_PER_SOCKET///< Max number of CCD per socket
...
typedef struct {
  ...
  LOGICAL_COMPLEX_INFO  ComplexMap[MAX_CCX_PER_CCD]; ///< Complex info per complex
...
typedef struct {
  ...
  bool  ApobErrorReportClearAcknowledgement; ///< Indicates if the ABL will clear acknowledgments
                                             ///< during protocol
                                             ///< (ABL internal use for resume/warm reset data xfer)
                                             ///< TRUE - Clear acknowledgments
                                             ///< FALSE - Do not clear acknowledgments
...
#define SIL_RSVD_ADDR_2690210C                         0x2690210C
#define SIL_RSVD_ADDR_6BF64BCD                            0x6BF64BCD
#define SIL_RSVD_ADDR_E56D9DFD                      0xE56D9DFD
#define SIL_RSVD_ADDR_25BC2451               0x25BC2451
#define SIL_RSVD_ADDR_43AF61E4               0x43AF61E4
#define SIL_RSVD_ADDR_9205EC2C               0x9205EC2C
#define SIL_RSVD_ADDR_A810A5EC               0xA810A5EC
#define SIL_RSVD_ADDR_5D416F23               0x5D416F23
#define SIL_RSVD_ADDR_9F73B7B7               0x9F73B7B7
#define SIL_RSVD_ADDR_959340B7               0x959340B7
#define SIL_RSVD_ADDR_B1DD628A               0xB1DD628A
#define SIL_RSVD_ADDR_D21F5DE9               0xD21F5DE9
#define SIL_RSVD_ADDR_2188B4FF               0x2188B4FF
#define SIL_RSVD_ADDR_2564FA4C              0x2564FA4C
#define SIL_RSVD_ADDR_2FF37BCD              0x2FF37BCD
#define SIL_RSVD_ADDR_CF8F3723              0xCF8F3723
#define SIL_RSVD_ADDR_21D9AECE              0x21D9AECE
#define SIL_RSVD_ADDR_7963FAC0              0x7963FAC0
#define SIL_RSVD_ADDR_D9265EF2              0xD9265EF2
...
typedef struct {
  ...
  LOGICAL_CORE_INFO_BRH    CoreInfo[CCX_MAX_CORES_PER_COMPLEX]; ///< Core info per core
} LOGICAL_COMPLEX_INFO_BRH;
...
typedef struct {
  ...
  LOGICAL_COMPLEX_INFO_BRH    ComplexMap[MAX_COMPLEXES_PER_CCD];   ///< Complex Info per CCD
} LOGICAL_CCD_INFO_BRH;
...
typedef struct {
  APOB_TYPE_HEADER      ApobTypeHeader;            ///< APOB Type Header
  LOGICAL_CCD_INFO_BRH  CcdMap[MAX_CCDS_PER_DIE];  ///< CCD Maps
} APOB_CCD_LOGICAL_TO_PHYSICAL_MAP_TYPE_STRUCT_BRH;
...
typedef struct {
  ...
  bool     NvDimmInstalled[ABL_APOB_MAX_CHANNELS_PER_DIE]; ///< NVDIMM presence per channel. ie.
  ...
  APOB_MEM_CFG_INFO MbistPerBitSlaveDieReport;                   ///< MBIST Per Bit Slave Die Report Configuration
  ...
  APOB_MEM_CFG_INFO NvdimmPowerSource;                           ///< NVDIMM Power Source Configuration
                                                                 ///< 1: device, 2: host
