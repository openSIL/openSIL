...
/** RcMgr Common External Data Block
 *  @details The major/minor version and instance of the RcMgr Data block.
 */
#define RCMGRCLASS_INSTANCE  0
 ...
 * SIL_RC_MGR_TYPE
 *
 * @brief This enum defines the resource manager tables supported by openSIL.
 *
 * @details When requesting resource manager tables, the table type must match one of these entries
 *
 */
typedef enum {
  IoMgrType = 0,
