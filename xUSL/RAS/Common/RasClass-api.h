...
/**
 *  RasClass-api.h - The follow structures are packed with 1 byte
 *        alignment:
 *
 *        SIL_ADDR_DATA
 *        SIL_MCA_INFO
...
typedef struct {
  SIL_CPU_INFO            CpuInfo;                               ///< Logical processor to Physical
                                                                 ///< processor map.
  size_t                  McaBankCount;                          ///< For SSP/GN/BA This is the max
                                                                 ///< bank number support for the
                                                                 ///< processor. For RS or later, this is
                                                                 ///< the Error bank count from the
                                                                 ///< processor
  SIL_MCA_BANK_ERROR_INFO McaBankErrorInfo[XMCA_MAX_BANK_COUNT]; ///< MCA bank register dump.
