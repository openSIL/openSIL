 ...
 */
uint32_t DfXFabricRegisterAccRead (uint32_t Socket, uint32_t Die, uint32_t Function, uint32_t Offset, uint32_t Instance)
{
  ...
  PciAddr.Address.Device = DfFabricRegisterAccGetPciDeviceNumberOfDie(Socket, Die);
