...
/** @brief Return values
 *
 * @details The SIL routines will never 'hang'. They will always return with a
 ...
 * all SIL code.
 * Starting from value 0xF0, this enum defines reset request types from SIL IPs.
 */
typedef enum {
...
#define SIL_TRACE_VERBOSE BIT_32(5)   ///< Messages shown only in verbose mode
