...
rem *  Copyright (C) 2021 - 2025 Advanced Micro Devices, Inc. All rights reserved.
goto START
:HELP
echo ** Kcfg.cmd
...
rem *  is also removed and only the next character is effectively escaped
...
if /i "%1"=="allyes" (
    ...
    echo ** Output to: %KCONFIG_CONFIG%,    %KCONFIG_AUTOHEADER%
    goto FINISH
)
