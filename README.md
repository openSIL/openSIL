# AMD openSIL: Turin Proof-of-Concept (POC)
...
1. Phase I   - Internal POCs (complete).
2. Phase II  - AMD openSIL POC open-sourced for evaluation on AMD 4th Gen EPYC&trade; based CRB (complete).
3. Phase III - AMD openSIL POC open-sourced for evaluation on AMD 5th Gen EPYC&trade; (codenamed Turin) based CRB (complete: this source).
...
1. Clone Repository:
   ...
   3. Run git to obtain the project:
      ...
      ```sh
      git clone -b turin_poc git@github.com:openSIL/openSIL.git
      ```
...
3. Configure your project
   ...
   * This release of the AMD openSIL libraries supports 5th Generation EPYC&trade; Processors (codenamed Turin) on the Galena and Purico CRBs only.
